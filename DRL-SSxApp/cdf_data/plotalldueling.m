...
filePattern = 'dueling*_mal_*_percent.csv'; % Adjust the pattern if necessary
...
title('CDF and Frequencies for Dueling Models with Different Malicious Percentages');
